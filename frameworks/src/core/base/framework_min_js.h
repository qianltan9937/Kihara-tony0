...
const char * const g_frameworkJSBuffer =
    ...
    "n(t,e){'function'==typeof e&&(e=e.call(t,t));if('undefined'!=typeof __appVing__&&__appVing"
    "__)return void(t.data=e);Object.keys(e).forEach((function(n){return function(t,e,n){Object"
    ".defineProperty(t,n,{enumerable:!1,configurable:!0,get:function(){return e[n]},set:functio"
    "n(t){e[n]=t}})}(t,e,n)})),o.of(e)}(e,i):'styleSheet'===n?initStyleSheet(i):'function'==typ"
    "eof i&&(e[n]=i.bind(e))}))}return c.prototype.$watch=function(t,e,n){return new i(this,t,e"
    ",n)},c}));";
#endif
